...
public class IdiomaForm extends javax.swing.JFrame {
    ...
    private void setupTableListener() {
        ...
        FrmTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) { // Evitar múltiples eventos
                    boolean filaSeleccionada = FrmTable.getSelectedRow() != -1;
                    Editbtn.setEnabled(filaSeleccionada);
                    deletebtn.setEnabled(filaSeleccionada);
                }
            }
        });
    }

    // Método público para que pueda ser llamado desde otros formularios
    public void cargarIdiomasEnTabla() {
        try {
    ...
    private void initComponents() {
        ...
        Addbtn.setBackground(new java.awt.Color(242, 242, 242));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Idiomas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14))); // NOI18N
        jPanel4.setLayout(new java.awt.GridBagLayout());

        FrmTable  = new javax.swing.JTable(){
            public boolean isCellEditable(int row,int column){
                for(int i = 0; i < FrmTable.getRowCount(); i ++){
                    if(row < 0){
                        return true;
                    }
                }
